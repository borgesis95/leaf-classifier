...
# Form implementation generated from reading ui file 'c:\Users\salva\OneDrive\Desktop\MACHINE_LEARNING\leaf-classifier\script\trainer-gui.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox.addItems(["SqeueezeNet","ResNet","GoogleNet"])
    ...
    def run_train(self):
        print("RUN")
        print("Modello",self.comboBox.currentText())
        print("Epcoche",self.textEdit.toPlainText())
